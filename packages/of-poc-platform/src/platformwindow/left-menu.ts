...
class LeftMenu extends HTMLElement {
    appList: TAppInfo[];
    layoutContainer: any;
    appInstanceCounter = new Map<string, number>();
    ...
    constructor() {
        ...
        this.appList = [
            {
                url: 'http://localhost:3201/cpuhogger/index.html',
                printName: 'CpuHogger',
            },
            {
                url: 'http://localhost:3201/cpuhogger/index.html',
    ...
    applySnapshotFromTemplate = async (templateName: string) => {
    ...
    replaceLayoutFromTemplate = async (templateName: any) => {
    ...
    addView = async (printName: string) => {
